          ...
          <section>
            <div className="flex max-w-5xl flex-col gap-5">
              <div className="flex items-center gap-2">
                ...
                <span>{userProfile?.username}</span>
                {
                  isLoggedInUserProfile ? (
                    ...
                    isFollowing ? (
                      <>
                        <Button variant='secondary' className="bg-[#0095F6]  h-8">Unfollow</Button>
                        <Button variant='secondary' className="bg-[#0095F6]h-8">Message</Button>
                      </>
              ...
              <div className="">
                <div className="">
                  <p className=''>
                    <span className='font-semibold'> {userProfile?.username.length}</span>
                    posts
                ...
                <div className='flex flex-col gap-1'>
                  ...
                  <Badge className='w-fit' variant='secondary'><AtSign />
                    <span className='pl-1'></span>
                    {userProfile?.username}</Badge>
                </div>
